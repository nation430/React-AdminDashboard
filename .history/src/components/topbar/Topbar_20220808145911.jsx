    ...
    return(
        <div className="topbar w-full ">
            ...
            <div className="topRight flex items-center">
                ...
                {/* First icon  */}
                <div className="topbarIconsContainer relative cursor-pointer ... ml-3 text-gray-500">
                <BiBell />
                <span className="topIconBadge absolute text-white bg-red-600 right-1 -top-1 flex items-center justify-center rounded-full text-xs h-3 w-3">2</span>
                   ...
                   {/*second icon  */}
                <div className="topbarIconsContainer relative cursor-pointer ... ml-3">
                <MdLanguage />
                <span className="topIconBadge absolute text-white bg-red-600 right-1 -top-1 flex items-center justify-center rounded-full text-xs h-3 w-3">2</span>
                </div>
                    ...
                    {/*third icon  */}
                <div className="topbarIconsContainer relative cursor-pointer ... ml-3 text-gray-800">
                < MdSettings  />
                </div>
            </div>
            </div>
