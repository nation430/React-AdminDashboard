...
export default function Topbar () {
    return(
        <div className="topbar w-full h-12 bg-red-900 sticky top-0  ">
            ...
            <div className="topRight flex items-center">
                ...
                <img src="images/img.png" alt="BigCo Inc. logo"  className="topAvater w-8 h-8 rounded-full cursor-pointer ..."/>
