        ...
        <div className="widgetLg p-5">
			...
			<tbody class="flex-1 sm:flex-none">
				<tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
					<td class="widgetLgUser flex items-center p-3 font-semibold">
					...
					<td class="widgetLgDate p-3 font-light">22 Aug 2022</td>
					<td class="widgetLgAmount p-3 font-light">$122.00</td>
