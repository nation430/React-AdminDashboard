    ...
    return(
        <div className="widgetSm p-5 mr-5">
            ...
            <ul className="widgetSmList">
                ...
                <button type="button" className="widgetSmButton bg-grey-900">
               <MdVisibility/>
               Display
                </button>
                <button class="bg-grey-900 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
